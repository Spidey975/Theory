...
var init = () => {
    ...
    // b1
    {
        ...
        b1 = theory.createUpgrade(0, currency, new ExponentialCost(1.1, Math.log2(1.000001)));
    ...
    // c1
    {
        ...
        c1 = theory.createUpgrade(1, currency, new ExponentialCost(1.1, Math.log2(2)));
    ...
    // c2
    {
        ...
        c2 = theory.createUpgrade(2, currency, new ExponentialCost(1.1, Math.log2(20)));
    ...
    
    {
        ...
        clicker.bought = (amount) => { prgGacha += 10 * amount * getSkillEffect(2) };
    }
    {
